...
public partial class SeatlyContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Restaura__3214EC27A74007C1");
        ...
        {
            entity.HasKey(e => e.TableId).HasName("PK__Restaura__7D5F018E10C07E28");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Restaura__3214EC2711CB2133");
        ...
        {
            entity.HasKey(e => e.WaitlistId).HasName("PK__Waitlist__FE78FE800B197E13");
