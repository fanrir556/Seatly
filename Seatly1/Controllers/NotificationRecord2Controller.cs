...
{
    public class NotificationRecord2Controller : Controller
    {
        private readonly SeatlyContext _context;

        public NotificationRecord2Controller(SeatlyContext context)
        {
            _context = context;
        }

        // GET: NotificationRecord2
        public async Task<IActionResult> Index()
        {
            return View(await _context.NotificationRecords.ToListAsync());
        }

        // GET: NotificationRecord2/Details/5
        ...
        // GET: NotificationRecord2/Create
        ...
        // GET: NotificationRecord2/Delete/5
        ...
        // POST: NotificationRecord2/Delete/5
        ...
        //GET: NotificationRecord2/GetActivityPhoto/(id)
